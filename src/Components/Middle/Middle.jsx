        ...
        <>
            <Grid  templateColumns='repeat(3, 1fr)' gap={14} p={2} backgroundColor={"#f7f2f9"}>
                ...
                <Box fontSize='4xl' fontWeight={"bold"}>
                        <Text>Find the job </Text>
                        <Text>by creating resume using platform <Text color={"purple"}>now</Text> </Text>
                    </Box>
                ...
                <Box fontSize='4xl' fontWeight={"bold"}>
                        <Text>Find the job </Text>
                        <Text>using AI built Resume <Text color={"purple"}>subscription based</Text> </Text>
                    </Box>
                    {/* <Image h={300} w={400} src="https://pbs.twimg.com/media/FiZ1mofXgAUK_TW.jpg" /> */}
                </Box>
            </Grid>
            ...
            <Box p={10}>
                ...
                <Grid templateColumns='repeat(5, 1fr)' gap={6}>
                    ...
                    <Box borderRadius={10} border={"1px solid gray"} p={2} backgroundColor={"#f7f2f9"}>
                        ...
                        <Box w={200}>
                            <Text fontSize={"lg"} fontWeight={"bold"} textAlign={"start"}>Search better using our platform</Text>
                            <Flex>
